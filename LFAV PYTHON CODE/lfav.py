...
class Unit:
    ...
    def battleStatWeapon(self, weaponChoice):
        ...
        if(self.equipped_weapon == "iron"):
            ...
            print("The attached weapon has no recorded value, so your attack will be set to 0.")
            self.attack = 0
...
def battleSimulate(unit1, unit2):
    ...
    while(battle):
        ...
        if(option == 2):
            ...
            if(hp == 1):
                ...
                print("Enter how much HP should be recovered.")
                hpCustom = int(input())
                ...
                print("Your input was unrecognized. Continuing...")
    ...
    print("Would you like to heal both characters? Enter 'Y'.")
    yes = input()
    if(yes == "Y" or yes == "y"):
        attackerUnit = storedUnit1
        defenseUnit = storedUnit2

        print("Unit HP has been restored.")
        attackerUnit.printCurrent()
        defenseUnit.printCurrent()
